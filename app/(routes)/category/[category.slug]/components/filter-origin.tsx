...
import { RadioGroup, RadioGroupItem } from "@/components/ui/radio-group"; // Asegúrate de que esto sea correcto
...
const FilterOrigin = (props: FilterOriginProps) => {
  ...
  return (
    <div className="my-5">
      ...
      {/* Asegúrate de que RadioGroupItem esté dentro de RadioGroup */}
